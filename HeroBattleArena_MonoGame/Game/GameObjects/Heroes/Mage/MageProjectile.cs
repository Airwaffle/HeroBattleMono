...
namespace HeroBattleArena.Game.GameObjects
{
    ...
    public MageProjectile(Unit owner, Vector2 direction)
    ...
    public override void Initialize()
    {
	    base.Initialize();
        Name = "MageProjectile";
        Texture = Graphics.GetTexture("Nano_shot");
	    Life = Configuration.GetValue("Mage_Projectile_Range")/Speed;
	    //m_boundingBox = new AABB(-10.0f,-10.0f, 20.0f, 20.0f, AABB::PROJECTILES_LAYER, AABB::PROJECTILES_COL, this);
    ...
    public override void OnCollide(AABB otherCol)
    {
	    ...
	    if ( otherCol.Owner is Unit){
		    if (((Unit)otherCol.Owner).IsAlive){
			    ((Unit)otherCol.Owner).ApplyDamage(Damage, Owner);
